...
CREATE TABLE IF NOT EXISTS `db`.`users` (
  ...
  INDEX `fk_users_articles1_idx` (`likes_id` ASC, `dislike_id` ASC) VISIBLE,
  CONSTRAINT `Role`
    FOREIGN KEY (`role_id`)
    ...
    ON UPDATE CASCADE,
  CONSTRAINT `Likes`
    FOREIGN KEY (`likes_id` , `dislike_id`)
    REFERENCES `db`.`articles` (`id` , `id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 29
