...
<div>Данный проект является учебным, некоторые технологии могут быть неоправданно использованными. Целью проекта является изучение фреймворка Flask, его встроенных технологий, таких как:</div>
