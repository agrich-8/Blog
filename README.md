...
<div><hr>
<h6>Данный проект является учебным, некоторые технологии могут быть неоправданными в использовании</h6>
...
<p>Создание тела статьи происходит при помощи TinyMCE. Особенностью ее использования является метод сохранения изображений: для этого используется отдельная функция, которая принимает POST запрос, извлекает из него изображения и сохраняет их. Это описание проекта создано именно на этой странице)</p>
